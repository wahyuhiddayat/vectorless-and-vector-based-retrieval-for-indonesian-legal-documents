...
def main() -> int:
    ...
    Stage 1 per-type tables go to appendix-bytype-tables.tex (Appendix 3)
    and the Stage 3 test table goes to appendix-test-tables.tex (Appendix 5).
    """
    ...
    (out_dir / "appendix-bytype-tables.tex").write_text("\n".join(stage1), encoding="utf-8")
